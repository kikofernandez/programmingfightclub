...
This mix of languages covers two different paradigms (object-oriented and functional
...
Choosing a language is an important design decision as languages are tied
to a paradigm and a type system, and these cannot be changed. If you are a consultant,
(one of the authors was a good one a few years ago but now he just research things)
and you are given a new project, you should
...
brings to the table. As usual, the more languages you know the better, since you
have more freedom to get to a good start with the main features of your chosen language.
<!--   -->
